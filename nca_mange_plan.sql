...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2025 at 04:24 AM
...
(34, 1, 'สายฟ้า', 'ทองดี', 1, 9, 2, 1, '2-3-1', 1),
(35, 2, 'อรุณ', 'มณี', 2, 10, 2, 1, '2-3-2', 1),
(36, 3, 'ประทีป', 'ศิริ', 1, 11, 2, 1, '2-3-3', 1),
(37, 1, 'รุ่ง', 'จิตร', 2, 12, 2, 1, '2-1-1', 2),
(38, 2, 'สุมาลี', 'บุญมาก', 2, 13, 3, 1, '3-3-1', 1),
(39, 3, 'พนม', 'ชูชาติ', 1, 14, 3, 1, '3-3-2', 1),
(40, 1, 'สมหมาย', 'สายใจ', 1, 15, 3, 1, '3-3-3', 1),
(41, 2, 'สุนี', 'ใจดี', 2, 16, 3, 1, '3-1-1', 1),
(42, 3, 'สุชาติ', 'มานะ', 1, 17, 4, 1, '4-3-1', 1),
(43, 1, 'ศิริพร', 'เพียรดี', 2, 18, 4, 1, '4-3-2', 1),
(44, 2, 'เจริญ', 'เอื้อเฟื้อ', 1, 19, 4, 1, '4-3-3', 1),
(45, 3, 'ผ่องศรี', 'วิชัย', 2, 20, 4, 1, '4-1-1', 1),
(46, 1, 'จิราพร', 'วิเศษ', 2, 0, 2, 2, '2-2-1', 1),
(47, 2, 'มานพ', 'เลิศ', 1, 0, 2, 2, '2-2-2', 1),
(48, 3, 'ปริญญา', 'เบิกบาน', 1, 0, 2, 2, '2-2-3', 1),
(49, 1, 'ชลธิชา', 'เพ็ญ', 2, 0, 2, 2, '2-1-1', 1),
...
--
-- Dumping data for table `employee_out`
--

INSERT INTO `employee_out` (`em_id`, `title_id`, `em_name`, `em_surname`, `gen_id`, `main_car`, `main_route`, `et_id`, `em_queue`, `es_id`) VALUES
(1, 1, 'สายฟ้า', 'ทองดี', 1, 9, 2, 1, '2-3-1', 1),
(2, 2, 'อรุณ', 'มณี', 2, 10, 2, 1, '2-3-2', 1),
(3, 3, 'ประทีป', 'ศิริ', 1, 11, 2, 1, '2-3-3', 1),
(4, 1, 'รุ่ง', 'จิตร', 2, 12, 2, 1, '2-1-1', 1),
(5, 2, 'สุมาลี', 'บุญมาก', 2, 13, 3, 1, '3-3-1', 1),
(6, 3, 'พนม', 'ชูชาติ', 1, 14, 3, 1, '3-3-2', 1),
(7, 1, 'สมหมาย', 'สายใจ', 1, 15, 3, 1, '3-3-3', 1),
(8, 2, 'สุนี', 'ใจดี', 2, 16, 3, 1, '3-1-1', 1),
(9, 3, 'สุชาติ', 'มานะ', 1, 17, 4, 1, '4-3-1', 1),
(10, 1, 'ศิริพร', 'เพียรดี', 2, 18, 4, 1, '4-3-2', 1),
(11, 2, 'เจริญ', 'เอื้อเฟื้อ', 1, 19, 4, 1, '4-3-3', 1),
(12, 3, 'ผ่องศรี', 'วิชัย', 2, 20, 4, 1, '4-1-1', 1),
(13, 1, 'จิราพร', 'วิเศษ', 2, 0, 2, 2, '2-2-1', 1),
(14, 2, 'มานพ', 'เลิศ', 1, 0, 2, 2, '2-2-2', 1),
(15, 3, 'ปริญญา', 'เบิกบาน', 1, 0, 2, 2, '2-2-3', 1),
(16, 1, 'ชลธิชา', 'เพ็ญ', 2, 0, 2, 2, '2-2-4', 1),
(17, 2, 'สุนันทา', 'นามดี', 2, 0, 3, 2, '3-2-1', 1),
(18, 3, 'วิทยา', 'รุ่งเรือง', 1, 0, 3, 2, '3-2-2', 1),
(19, 1, 'อารี', 'มั่นคง', 1, 0, 3, 2, '3-2-3', 1),
(20, 2, 'บรรเจิด', 'ก้องเกียรติ', 1, 0, 3, 2, '3-2-4', 1),
(21, 3, 'จันทร์เพ็ญ', 'วรางค์', 2, 0, 4, 2, '4-2-1', 1),
(22, 1, 'ณัฐ', 'เสริมสุข', 1, 0, 4, 2, '4-2-2', 1),
(23, 1, 'สุนทร', 'กิติ', 1, 0, 2, 3, '2-2-1', 1),
(24, 2, 'พชร', 'จันทรา', 2, 0, 2, 3, '2-2-2', 1),
(25, 3, 'อารีย์', 'บุญมาก', 2, 0, 2, 3, '2-2-3', 1),
(26, 1, 'วิชัย', 'เกียรติคุณ', 1, 0, 2, 3, '2-2-4', 1),
(27, 2, 'สายพิณ', 'สวัสดี', 2, 0, 3, 3, '3-2-1', 1),
(28, 3, 'สุพัตรา', 'เรืองศรี', 1, 0, 3, 3, '3-2-2', 1),
(29, 1, 'จันทร์', 'สามัคคี', 2, 0, 3, 3, '3-2-3', 1),
(30, 2, 'ประเสริฐ', 'วัฒนกิจ', 1, 0, 3, 3, '3-2-4', 1),
(31, 3, 'สายใจ', 'สมบูรณ์', 2, 0, 4, 3, '4-2-1', 1),
(32, 1, 'อุษา', 'แสงทอง', 2, 0, 4, 3, '4-2-2', 1),
(33, 2, 'พิมพ์', 'เรืองเดช', 2, 0, 4, 2, '4-2-3', 1),
(34, 3, 'อภิชาติ', 'เพชรดี', 1, 0, 4, 2, '4-1-1', 1),
(35, 2, 'อภิญญา', 'รัตนชัย', 2, 0, 4, 3, '4-2-3', 1),
(36, 3, 'เกรียงไกร', 'พูนผล', 1, 0, 4, 3, '4-1-1', 1);
...
CREATE TABLE `queue_request` (
  ...
  `br_id` int(11) NOT NULL,
  `qr_request` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Indexes for table `employee_out`
--
ALTER TABLE `employee_out`
  ADD PRIMARY KEY (`em_id`);
...
--
-- AUTO_INCREMENT for table `employee_out`
--
ALTER TABLE `employee_out`
  MODIFY `em_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
