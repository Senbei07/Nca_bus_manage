<?php
    ...
    $sql_main = "SELECT * FROM `employee` WHERE et_id = 1 AND em_queue < '3-1'";
    $sql_ex = "SELECT * FROM `employee` WHERE et_id = 2 AND em_queue < '2-1'";
    $sql_coach = "SELECT * FROM `employee` WHERE et_id = 3 AND em_queue < '2-1'";
